<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="LoginServlet?action=logout"><i
                                            class="fas fa-sign-out-alt"></i> Logout</a>
                                </li>
                                <li class="nav-item d-lg-none">
                                    <button class="nav-link btn" onclick="toggleCart()">
                                        <i class="fas fa-shopping-cart"></i> Cart <span class="cart-badge"
                    ...
                    <div>
                        ...
                        <div class="menu-section" id="menuSection">
                            <% try { MenuDaoImpl menuDao=new MenuDaoImpl(); List<Menu> menuItems =
                                menuDao.getMenuByRestaurant(1); // Default restaurant ID

                                if (menuItems != null && !menuItems.isEmpty()) {
                                for (Menu menu : menuItems) {
                                %>
                                <div class="menu-card">
                                    <img src="<%= menu.getImageUrl() != null ? menu.getImageUrl() : "
                                        images/menu/default.jpg" %>" class="menu-card-image" alt="<%= menu.getItemName()
                                        %>">
                                        <div class="menu-card-content">
                                            ...
                                            <div class="menu-card-footer">
                                                <div>
                                                    <div class="menu-price">₹<%= String.format("%.2f", menu.getPrice())
                                                            %>
                                                    </div>
                                                    <div class="menu-rating"><i class="fas fa-star"></i>
                                                        <%= menu.getRating() %>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <% } } else { %>
                                    <div
                                        style="grid-column: 1 / -1; text-align: center; padding: 50px 20px; color: #999;">
                                        <p><i class="fas fa-inbox" style="font-size: 48px; opacity: 0.5;"></i></p>
                                        <p>No items available</p>
                                    </div>
                                    <% } } catch (Exception e) { e.printStackTrace(); %>
                                        <div
                                            style="grid-column: 1 / -1; text-align: center; padding: 50px 20px; color: #dc3545;">
        ...
        <%
                        Cart cartForJs = (Cart) session.getAttribute("cart");
                    if (cartForJs != null && cartForJs.getItems() != null && !cartForJs.getItems().isEmpty()) {
                        for (Map.Entry < Integer, Cartitem > entry : cartForJs.getItems().entrySet()) {
                    Cartitem item = entry.getValue();
        %>
                                cartItems[<%= item.getMenuId() %>] = {
        ...
        <div class="cart-item">
            ...
            <div class="cart-item-actions">
                <form action="CartServlet" method="POST" style="display:inline;">
                    ...
                    <button type="submit" class="cart-item-btn">-</button>
                </form>
                <form action="CartServlet" method="POST" style="display:inline;">
                    <input type="hidden" name="action" value="update">
                    <input type="hidden" name="ItemId" value="${menuId}">
                ...
                <form action="CartServlet" method="POST" style="display:inline;">
                    ...
                    <input type="hidden" name="ItemId" value="${menuId}">
                    <button type="submit" class="cart-item-btn remove"><i class="fas fa-trash"></i></button>
                </form>
            </div>
        </div>
    `;
